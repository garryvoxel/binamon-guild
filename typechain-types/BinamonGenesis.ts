...
export interface BinamonGenesisInterface extends utils.Interface {
  contractName: "BinamonGenesis";
  functions: {
...
export interface BinamonGenesis extends BaseContract {
  contractName: "BinamonGenesis";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BinamonGenesisInterface;
