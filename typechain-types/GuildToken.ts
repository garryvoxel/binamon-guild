...
export interface GuildTokenInterface extends utils.Interface {
  contractName: "GuildToken";
  functions: {
    ...
    "mintGuildTokens(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "mintGuildTokens",
    values: [string, BigNumberish]
  ): string;
...
export interface GuildToken extends BaseContract {
  contractName: "GuildToken";
